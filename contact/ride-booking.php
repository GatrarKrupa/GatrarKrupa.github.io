...
function sendBookingEmail(){
	...
	if(!empty($_POST['formData'])){
		...
		$rider_fname = filter_var($formData['fname'], FILTER_SANITIZE_STRING);
		$rider_lname = filter_var($formData['lname'], FILTER_SANITIZE_STRING);
		$rider_name = $rider_fname." ".$rider_lname;
